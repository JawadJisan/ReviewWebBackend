...
exports.reviewCategoryService = void 0;
...
const insertIntoDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.reviewCategory.create({
        data,
    });
    return result;
});
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const andConditions = (0, findFilterConditions_1.findFilterConditionsWithoutRelation)(searchTerm, filterData, serviceCategory_constant_1.serviceCategorySearchableFields);
    ...
    const result = yield prisma_1.default.reviewCategory.findMany({
...
const getDataById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.reviewCategory.findUnique({
        where: {
            id,
        },
    });
...
const updateDataById = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.reviewCategory.update({
        where: {
            id,
        },
        data: payload,
...
const deleteDataById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.reviewCategory.delete({
        where: {
            id,
        },
    });
